    ...
    <>
      ...
      <div className={`w-full h-adjust px-10 ${backgroundColour}`}>
        <div className="flex mx-auto justify-center content-center min-h-adjust flex-wrap space-y-4 sm:space-y-10 lg:space-y-0 sm:flex-nowrap sm:py-10">
          <img src="/images/people-carousel.gif" className="m-auto w-2/4 h-2/4 min-w-image-sm sm:h-1/6 sm:w-1/6" />
          <div className="flex flex-col justify-center space-y-5 sm:space-y-10 mx-auto">
            <h1 className="mx-auto text-center lg:text-left max-w-xs sm:max-w-sm md:max-w-md tracking-widest leading-tight text-xl sm:text-2xl md:text-4xl lg:text-5xl text-grey font-bold">
